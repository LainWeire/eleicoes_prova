...
with col2:
    if st.button("Discurso do candidato 2"):
        st.write("[Abrir Discurso do Candidato 2](https://drive.google.com/file/d/1bkQBIT-VOzSOpsaIwRznS-MUA1daJItR/view)")
...
if st.session_state.ja_votou:
    ...
    with col3:
        if st.button("Votar no Candidato 1", key='candidato1'):  
            registrar_voto("Candidato 1", "dados123.csv")
